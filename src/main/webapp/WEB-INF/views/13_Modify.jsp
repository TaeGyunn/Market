...
<style>
	...
	input[type="button"]{
		width:100px; height:50px; border:1px solid #5F0080; border-radius:3px; cursur:pointer; background-color:white;
		color:#5F0080; margin-right:5px;
	}
</style>
</head>
<body>
	...
	<div class="Mid_info">
		...
		<div class="Mid_info_right">
			...
			<hr>
			<div class="box3">
				<form:form method="post" action ="/Modify" commandName="mem">
					<table>
						<tr>
							<td>아이디</td>
							<td>   </td>
						...
						<tr>
							<td>현재 비밀번호</td>
							<td>   </td>
							<td colspan="2"><input type="text" value="${member.memPw}"/></td>
						</tr>
						<tr>
							<td>새 비밀번호</td>
							<td>   </td>
						...
						<tr>
							<td>이름</td>
							<td>   </td>
							<td colspan="2"><form:input path="memName" /></td>
						</tr>
						<tr>
							<td>이메일</td>
							<td>   </td>
							<td colspan="2"><form:input path="memEmail" /></td>
						</tr>
						<tr>
							<td>휴대폰</td>
							<td>   </td>
							<td colspan="2"><form:input path="memNumber" /></td>
						</tr>
					</table>
					<hr>
					<div class="box4"> 
					<input type="submit" value="회원정보수정">
					<input type="button" value="회원탈퇴" onclick="location.href='/Withdrawal'">
					</div>
				</form:form>
			</div>
		</div>
