...
<style>
	...
	.Mid_info_right{
		width:800px; height:400px; margin-left:20px;
	}
	.Mid_info_right p{
		font-weight:bold; font-size:22px; 
	}
	.Mid_info_right .box1{
		margin-top:45px; height:25px; 
	}
	.Mid_info_right .box1 p{
		font-weight:bold; font-size:17px; color:black;
	}
	.Mid_info_right .box2{
		margin-top:5px; height:25px; 
	}
	.Mid_info_right .box2 p{
		font-weight:bold; font-size:10px; color:grey;
	}
	.Mid_info_right hr{
	...
	input[type="submit"]{
		width:200px; height:50px; border:1px solid #5F0080; border-radius:3px; cursur:pointer; background-color:#5F0080;
		color:white; 
	}
	.Mid_info_right .box4{
...
<body>
<c:import url="/WEB-INF/views/11_TopMini.jsp"/>
<c:import url="/WEB-INF/views/12_Info.jsp"/>
	<div class="Mid_info">
		...
		<div class="Mid_info_right">
			...
			<hr>
			<div class="box3">
				<form:form method="post" action="/pwcheck" commandName="mem">
					<table>
						<tr>
							<td>아이디</td>
							<td>   </td>
					...
					<hr>
					<div class="box4">
					<input type="submit" class="white" value="확인" >
					</div>
				</form:form>
			</div>
		</div>
