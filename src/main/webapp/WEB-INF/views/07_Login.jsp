...
<c:import url="/WEB-INF/views/02_Top.jsp"/>
	<div class="main">
		<div class="main1">로그인</div>
		<div class="mainn2">
		<form:form method="post" action="/login" commandName="mem">
				<table>
					<tr>
						<td colspan="2"><form:input path="memId" placeholder="아이디를 입력해주세요"/></td>
					</tr>
					<tr>
						<td colspan="2"><form:input path="memPw" placeholder="비밀번호를 입력해주세요"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><button class="pupple" onclick="location.href= '${cp}/Kurly/05_Join'" >회원가입</button></td>
					</tr>
				</table>
			</form:form>
		</div>
